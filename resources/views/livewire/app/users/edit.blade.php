<div>
    ...
    <div  @click="@this.edit" class="w-4 mr-2 transform cursor-pointer hover:text-purple-500 hover:scale-110" title="Editar Usuários">
    ...
    <x-modal.card title="Editar usuário {{ $user->name }}" blur wire:model.defer="modalUserUpdate">
